		...
		<div className="group relative flex-shrink-0 text-white transition-all duration-300 w-36 transform mx-auto overflow-visible ">
			...
			>
				...
				<button
					onClick={handleClick}
					type="button"
					className="border-2 border-yellow-500 text-white text-sm px-1 py-2 rounded-lg mt-2 transition-all duration-300 ease-out hover:bg-yellow-500 hover:text-black w-full"
				>
					Choose
				</button>
